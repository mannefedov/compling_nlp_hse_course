...
Сделав все домашки на отлично можно будет получить 5 баллов.

### 2. Итоговый тест
В конце курса будет тест по всем пройденным темам (включая семинары и домашки)
Написав тест на отлично, можно будет заработать 3 балла.
...
### 4. Проект (небольшой)
Если не готовы взяться за большой проект, но хотели бы углубиться в какую-то из проходимых систем, можно сделать небольшой проект.
